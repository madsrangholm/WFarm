...
//        /// </summary>
//        private static LibGpio _instance;

//        /// <summary>
//        /// Stores the configured directions of the GPIO ports
//        /// </summary>
//        private readonly Dictionary<BroadcomPinNumber, Direction> _directions = new Dictionary<BroadcomPinNumber, Direction>();
...
//        {
//            get { return _instance ?? (_instance = new LibGpio()); }
//        }
...
//            if (!this._directions.ContainsKey(pinNumber))
//            {
...
//            if (this._directions[pinNumber] == Direction.Input)
//            {
...
//            // Check that the channel is not being used incorrectly
//            if (this._directions[pinNumber] == Direction.Output)
//            {
...
//            if (this._directions.ContainsKey(pinNumber))
//            {
//                this._directions[pinNumber] = direction;
//            }
//            else
//            {
//                this._directions.Add(pinNumber, direction);
//            }
